...
{
	/// <summary>
	/// Working with Slippi before, the entire game uses BigEndian numbers while C# defaults to Small on most systems.
	/// These structs are made to just convert everything over to for sure be big endian.
	/// </summary>
